...
if ($_POST["address_name"] == "") {
    header("Location: ../lib/addressfetchbyaddressid.php?edit=$address_id&error=address_name");
    exit;
} elseif ($_POST["floor_unit"] == "") {
    header("Location: ../lib/addressfetchbyaddressid.php?edit=$address_id&error=floor_unit");
    exit;
} elseif ($_POST["state"] == "") {
    header("Location: ../lib/addressfetchbyaddressid.php?edit=$address_id&error=state");
    exit;
} elseif ($_POST["district"] == "") {
    header("Location: ../lib/addressfetchbyaddressid.php?edit=$address_id&error=district");
    exit;
} elseif ($_POST["postcode"] == "") {
    header("Location: ../lib/addressfetchbyaddressid.php?edit=$address_id&error=postcode");
    exit;
} else {
